...
El siguiente problema fue la interpretación de los datos recogidos por el sensor. El ML8511 trabaja usando una especie de sensor sensible a la luz que funciona de la siguiente manera: + luz = + voltaje
...
La solución ha dicho problema fue conectar la salida del sensor a un pin del canal ADC1, que va del pin 32 al 39.
